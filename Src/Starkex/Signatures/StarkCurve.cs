...
namespace Starkex.Signatures
{
    public class StarkCurve
    {
        ...
        private static readonly StarkCurve instance = new StarkCurve();
        private readonly ECCurve curve;
        private readonly ECPoint pointG;

        private StarkCurve()
        {
            ECCurve dummy = new FpCurve(P, A, B, N, H);
        ...
        {
            return curve.A.ToBigInteger();
        }

        public BigInteger GetB()
        {
            return curve.B.ToBigInteger();
        }

        public BigInteger GetN()
        {
            return new BigInteger(curve.Order.ToString());
        }

        public BigInteger GetH()
        {
            return new BigInteger(curve.Cofactor.ToString());
        }
